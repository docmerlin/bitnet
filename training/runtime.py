...
def build_model_config(args: argparse.Namespace, tokenizer: HierarchicalTokenizer) -> TernaryConfig:
    ...
    kwargs: dict = {
        ...
        "use_mamba3_layers": getattr(args, "mamba3_layers", defaults.use_mamba3_layers),
        "mamba_layer_period": getattr(args, "mamba_layer_period", defaults.mamba_layer_period),
        "mamba_d_state": getattr(args, "mamba_d_state", defaults.mamba_d_state),
        "mamba_expand": getattr(args, "mamba_expand", defaults.mamba_expand),
        "attn_res_mode": getattr(args, "attn_res_mode", defaults.attn_res_mode),
