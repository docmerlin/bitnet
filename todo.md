...
**2026-09-06 audit: remove repeated work before adding kernels.**

These are source-backed candidates, not measured speedups. The audit inspected the
current worktree, including uncommitted changes, without modifying implementation files.
Suggested first batch: bounded draft embeddings, patcher bookkeeping, and corpus indexing;
...
Keep rejected BLT QKV/gate-up fusion, multi-slot gather attention, monolithic backward/CMUD
fusion, and unstable Neumann-series PaTH solves out of this work unless new evidence warrants
revisiting them.
